...
while running:
    ...
    player_rect = pygame.Rect(car_x + 30, car_y, car_width - 65, car_height)
    


    #check for collision with each enemy car
    for enemy in opposing_cars:
        enemy_rect = pygame.Rect(enemy.x + 30, enemy.y, car_width - 65, car_height)#plus and minus to shrink hitboxes
